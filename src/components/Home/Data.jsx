...
export default function Data() {
  ...
  return (
    <div className="home__data">
        <h1 className="home__title">Shiva Chary
        {/* <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description"> {/*Logician fueling innovation. Thriving in change, I turn challenges into opportunities. Let's dream, create and inspire!*/}{displayedText}</p>
