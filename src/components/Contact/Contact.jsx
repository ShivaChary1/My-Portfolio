    ...
    <section className="contact section" id="contact">
        ...
        <div className="contact__container container grid">
            <div className="contact__content">
                <h3 className="contact__titile">Talk to me</h3>

                <div className="contact__info">
                    <div ref={ref1} className="contact__card">
                    ...
                    <div ref={ref2} className="contact__card">
                        <i className="bx bxl-whatsapp contact__card-icon"></i>

                        <h3 className="contact__card-title">Whatsapp</h3>
                        <span className="contact__card-data">9912303178</span>

                        <a href="https://api.whatsapp.com/send?phone=9640441246&text=Hello, Shiva chary!" className="contact__button">
                            Write me <i className="bx bx-right-arrow-alt contact__button-icon"></i>
                        </a>

                    </div>
                    <div ref={ref3} className="contact__card">
            ...
            <div ref={ref4} className="contact__content">
